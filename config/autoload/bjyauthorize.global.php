        ...
        */
        ...
        'guards' => [
            ...
            \BjyAuthorize\Guard\Controller::class => [
                ...
                ['controller' => 'Admin\Controller\ProductPrice',        'roles' => ['Admin_ProductPrice',              'admin', 'supradm']],
                ['controller' => 'Admin\Controller\ProductVariant',      'roles' => ['Admin_ProductVariant',            'admin', 'supradm']],
                ['controller' => 'Admin\Controller\ProductVariantValue', 'roles' => ['Admin_ProductVariantValue',       'admin', 'supradm']],
                ['controller' => 'Admin\Controller\Tax',                 'roles' => ['Admin_Tax',                       'admin', 'supradm']],
                ['controller' => 'Admin\Controller\Deadline',            'roles' => ['Admin_Deadline',                  'admin', 'supradm']],
                ['controller' => 'Admin\Controller\Agegroup',            'roles' => ['Admin_Agegroup',                  'admin', 'supradm']],
                ['controller' => 'Admin\Controller\PaymentType',         'roles' => ['Admin_PaymentType',               'admin', 'supradm']],
                ['controller' => 'Admin\Controller\Counter',             'roles' => ['Admin_Counter',                   'admin', 'supradm']],
                ['controller' => 'Admin\Controller\User',                'roles' => ['Admin_User', 'preregcoordinator', 'admin', 'supradm']],
