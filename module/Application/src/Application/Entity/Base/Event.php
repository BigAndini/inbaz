 ...
 * Version 2.1.6-dev (doctrine2-mappedsuperclass) on 2017-01-21 15:18:50.
...
class Event extends \Application\Entity\EntityValidation
{
     ...
     * @Annotation\Attributes({"placeholder":"Name...", "class": "form-control"})
     *
     ...
     * @Annotation\Attributes({"placeholder":"Beginn...", "class": "form-control"})
     *
     ...
     * @Annotation\Attributes({"placeholder":"Ende...", "class": "form-control"})
     *
     ...
     * @Annotation\Attributes({"placeholder":"Kontakt...", "class": "form-control"})
     *
     ...
     * @Annotation\Attributes({"placeholder":"E-Mail...", "class": "form-control"})
     *
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    protected $email;
     ...
     * @Annotation\Attributes({"placeholder":"Webseite...", "class":
     * "form-control"})
     *
     * @ORM\Column(type="string", length=255, nullable=true)
     */
     ...
     * @Annotation\Attributes({"placeholder":"Beschreibung...", "class":
     * "form-control"})
     *
